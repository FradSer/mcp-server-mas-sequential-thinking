...
- 避免不必要的背景展开"""
    ...
    def post_process_deepseek_response(self, response: str) -> str:
        ...
        response = self._add_human_connection(response)
...
def test_deepseek_optimization():
    ...
    optimized = optimizer.optimize_prompt_for_deepseek(original_prompt, "philosophical")
...
"""
    ...
    processed = optimizer.post_process_deepseek_response(problematic_response)
