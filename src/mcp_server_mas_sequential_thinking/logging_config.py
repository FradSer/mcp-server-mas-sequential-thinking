...
class SmartLogger:
    ...
    def __init__(self, log_level: SmartLogLevel = SmartLogLevel.PERFORMANCE):
...
class LoggerFactory:
    ...
    def get_logger(cls, name: str) -> logging.Logger:
        ...
        elif name == "__main__" or name == "sequential_thinking":
...
__all__ = [
    # Core configuration
    "LogLevel", "SmartLogLevel", "LogFormat", "LogTarget",
    "LoggingConfig", "LoggerFactory",

    # Main functions
    "setup_logging", "get_logger", "get_smart_log_level", "reload_logging_config",

    # Smart logging
    "SmartLogger", "PerformanceMonitor", "ProcessingSnapshot",
    "configure_smart_logging", "log_thought_processing", "log_session_end",

    # Metrics logging
    "MetricsLogger", "MetricsConfig", "PerformanceTracker",

    # Security
    "SensitiveDataFilter", "JSONFormatter",

    # Global instances
    "smart_logger", "performance_monitor"
]